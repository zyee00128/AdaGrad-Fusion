...
from model_src_ecg.model_code_default import NN_default, Cutmix
import os
...
def model_config_initialization(args, loader_train, device='cuda:0'):
    ...
    if args.ranklist == 'lora_grad': ## One-shot Rank Allocation based on the importance of each low-rank matrix.
        args.r_low = r // 4 * 2
        net = NN_default(nOUT=num_class, complexity=complexity, inputchannel=num_leads, num_layers=num_layers,
